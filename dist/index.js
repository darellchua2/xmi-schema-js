...
import { XmiBaseGeometry } from "./v1/geometries/XmiBaseGeometry";
import { XmiPoint3D } from "./v1/geometries/XmiPoint3D";
import { XmiLine3D } from "./v1/geometries/XmiLine3D";
// Export the XmiBaseEntity class
export { XmiBaseEntity, XmiBaseRelationship };
export { XmiSegmentType, XmiUnitEnum };
export { XmiBaseGeometry };
export { XmiPoint3D };
export { XmiLine3D };
